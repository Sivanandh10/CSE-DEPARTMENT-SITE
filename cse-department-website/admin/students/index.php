...
<head>
    ...
    <title>Manage Students | CSE Department</title>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo '<tr><td>' . htmlspecialchars($row['name']) . '</td><td>' . htmlspecialchars($row['roll_number']) . '</td><td>' . htmlspecialchars($row['batch']) . '</td><td><a href="edit.php?id=' . $row['id'] . '" class="btn btn-sm btn-warning">Edit</a> <a href="delete.php?id=' . $row['id'] . '" class="btn btn-sm btn-danger">Delete</a></td></tr>';
                        }
                        ?>
                    </tbody>
                </table>
